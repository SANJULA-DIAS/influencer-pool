  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="text-[#FF6B6B]">Show All</button>
      </div>
